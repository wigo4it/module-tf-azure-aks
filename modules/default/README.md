...
| <a name="input_local_account_disabled"></a> [local\_account\_disabled](#input\_local\_account\_disabled) | (Optional) Disable local accounts for security compliance. This is recommended. | `bool` | `true` | no |
