module github.com/your-org/module-haven-cluster-azure-digilab/tests
...
replace github.com/Azure/azure-sdk-for-go => github.com/Azure/azure-sdk-for-go v59.0.0+incompatible
