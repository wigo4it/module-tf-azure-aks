...
| <a name="input_assign_private_dns_zone_rbac"></a> [assign\_private\_dns\_zone\_rbac](#input\_assign\_private\_dns\_zone\_rbac) | (Optional) Assign 'Private DNS Zone Contributor' to the UAI | `bool` | `false` | no |
